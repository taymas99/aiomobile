...
Facebook: facebook.com/netyynasfacebook
Ver: 228
----
FOR LOLZTEAM
----
...
while loop:
    ...
    if what == "1":
        ...
        os.system("cd /data/data/com.termux/files/home")
        os.system("pkg update -y")
        os.system("cd /data/data/com.termux/files/home && git clone https://github.com/jseidl/GoldenEye.git")
        os.system("cd /data/data/com.termux/files/home")
        print("====================================")
